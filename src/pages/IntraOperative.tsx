...
import { Play, Search, FileEdit, Clock, CheckCircle, Activity, AlertTriangle, ArrowRight, Trash2 } from 'lucide-react';
...
export default function IntraOperative() {
  ...
  // Auto-open surgery from URL parameter
  useEffect(() => {
  ...
  const completeSurgeryMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['intraop-surgeries'] });
      toast.success('Surgery completed. Patient moved to post-operative care.');
      setNotesDialogOpen(false);
      setSelectedSurgery(null);
    },
    onError: (error: Error) => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Document ongoing surgical procedures</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Document the surgical procedure, findings, techniques used..."
                rows={6}
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Document any complications or unexpected findings..."
                rows={3}
              />
            </div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="secondary" onClick={saveNotes} disabled={updateSurgeryMutation.isPending}>
                Save Notes
              </Button>
              <Button
                onClick={completeSurgery}
                disabled={!intraOpNotes.trim() || completeSurgeryMutation.isPending}
                className="gap-1"
              >
